...
export default class FastEnemyGroup extends Phaser.Group {
  constructor(game, parent, enemyCount) {
    super(game);
    this.enableBody = true;
    this.physicsBodyType = Phaser.Physics.ARCADE;
    this.createMultiple(enemyCount, `enemy3`);
    ...
    this.forEach(enemy => {
      ...
      enemy.body.setSize(50, 50, 30, 100);
    });
  ...
  enemyFollow(player) {
    this.forEach(enemy => {
      if (enemy.alive) {
        ...
        this.game.physics.arcade.moveToObject(enemy, player, 75);
